              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex space-x-2">
                    ...
                    >
                      <option value="builtin-ai">{t('builtInAI')}</option>
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4 shadow-xl">
          ...
          <div className="mt-6 flex justify-end">
            <button
              onClick={() => {
                const micDevice = selectedDevices.micDevice || t('defaultDevice');
                const systemDevice = selectedDevices.systemDevice || t('defaultDevice');
        ...
        <div className="bg-white rounded-lg max-w-4xl w-full mx-4 shadow-xl max-h-[90vh] flex flex-col">
          ...
          <div className="flex justify-between items-center p-6 pb-4 border-b border-gray-200">
            <h3 className="text-lg font-semibold text-gray-900">
              {messages.modelSelector ? t('transcriptionSetupRequired') : t('transcriptionModelSettings')}
            </h3>
            <button
          ...
          <div className="flex-1 overflow-y-auto p-6 pt-4">
            {messages.modelSelector && (
              <div className="mb-5 whitespace-pre-line rounded-lg border border-amber-200 bg-amber-50 p-4 text-sm text-amber-900">
                {messages.modelSelector}
              </div>
            )}
            <TranscriptSettings
          ...
          <div className="p-6 pt-4 border-t border-gray-200 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">{t('confidenceIndicatorsDescription')}</p>
              </div>
            </div>
