  ...
  return (
    <>
      <div className="space-y-4">
        <div>
          <h3 className="text-base font-semibold text-gray-800 mb-2">{t('usageAnalytics')}</h3>
        ...
        <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-200">
          <div>
            <h4 className="font-semibold text-gray-800">{t('enableAnalytics')}</h4>
            <p className="text-sm text-gray-600">
              {isProcessing ? t('updating') : t('analyticsOffByDefault')}
            </p>
          </div>
          ...
          <div className="p-4 border rounded-lg bg-gray-50">
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1 min-w-0">
                <div className="font-medium text-gray-800 mb-1">{t('yourUserId')}</div>
