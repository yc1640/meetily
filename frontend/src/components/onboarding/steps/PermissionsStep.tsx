...
export function PermissionsStep() {
  ...
  const handleMicrophoneAction = async () => {
    if (permissions.microphone === 'denied') {
      ...
      try {
        ...
        alert(t('microphonePermissionInstruction'));
      }
      return;
    }
  ...
  const handleSystemAudioAction = async () => {
    if (permissions.systemAudio === 'denied') {
      ...
      try {
        ...
        alert(t('systemAudioPermissionInstruction'));
      }
      return;
    }
  ...
  return (
    <OnboardingContainer
      title={t('grantPermissions')}
      description={t('grantPermissionsDescription')}
      step={4}
      hideProgress={true}
      ...
      <div className="max-w-lg mx-auto space-y-6">
        ...
        <div className="space-y-4">
          ...
          <PermissionRow
            ...
            title={t('microphone')}
            description={t('microphonePermissionDescription')}
          ...
          <PermissionRow
            ...
            title={t('systemAudio')}
            description={t('systemAudioPermissionDescription')}
