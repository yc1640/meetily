        ...
        <Alert variant="destructive" className="border-amber-400 bg-amber-50">
            ...
            <div className="flex items-center gap-2">
              ...
              {!hasMicrophone && !hasSystemAudio
                ...
                : !hasMicrophone
                  ...
                  : t('systemAudioPermissionRequired')}
            </div>
          </AlertTitle>
          {/* Action Buttons */}
          ...
          <AlertDescription className="text-amber-800 mt-2">
            ...
            {!hasMicrophone && (
              <>
                <p className="mb-3">
                  {t('microphoneAccessMissing')}
                </p>
                <div className="space-y-2 text-sm mb-4">
                  <p className="font-medium">{t('pleaseCheck')}</p>
                  <ul className="list-disc list-inside ml-2 space-y-1">
                    <li>{t('microphoneConnected')}</li>
                    <li>{t('microphonePermissionGranted')}</li>
                    <li>{t('microphoneNotExclusive')}</li>
                  </ul>
                </div>
              </>
            )}
            ...
            {!hasSystemAudio && (
              <>
                <p className="mb-3">
                  {hasMicrophone
                    ? t('systemAudioMicrophoneOnly')
                    : t('systemAudioAlsoUnavailable')}
                </p>
                {isMacOS && (
                  <div className="space-y-2 text-sm mb-4">
                    <p className="font-medium">{t('enableSystemAudioMac')}</p>
                    <ul className="list-disc list-inside ml-2 space-y-1">
                      <li>{t('installVirtualAudioDevice')}</li>
                      <li>{t('grantScreenRecordingPermission')}</li>
                      <li>{t('configureAudioRouting')}</li>
                    </ul>
                  </div>
                )}
              </>
