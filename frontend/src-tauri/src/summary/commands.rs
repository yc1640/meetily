...
use crate::summary::processor::SummaryDetailLevel;
...
pub async fn api_process_transcript<R: Runtime>(
    ...
    summary_detail_level: Option<SummaryDetailLevel>,
    summary_language: Option<String>,
    _auth_token: Option<String>,
    ...
    let final_detail_level = summary_detail_level.unwrap_or_default();
