...
impl RecordingManager {
    ...
    /// * `transcription_enabled` - Whether to run VAD and forward speech to a transcription provider
    pub async fn start_recording(
        ...
        info!(
            "Starting recording manager (auto_save: {}, transcription_enabled: {})",
            auto_save, transcription_enabled
        );

        // Avoid creating a VAD/transcription channel at all for recording-only sessions.
